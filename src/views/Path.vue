<template>
    <div>
        ...
        <div class="path-chart border border-blue-600 "></div>
    </div>
</template>
<script>
...
export default {
    ...
    mounted() {
        ...
        const svg = d3.select(".path-chart").append('svg')
        ...
        // let scale = d3.scaleBand().domain(data.map(d => d.date)).range([0, width]);
        ...
        //     .selectAll("text")
        //     .attr("color", "#00585F")
        //     .attr('class', 'uppercase font-normal text-[8px] rotate-45')
